/**
 * Page01Opening.js - 開場頁
 * "你的 2025 Threads 之旅"
 */

import { StoryPage } from '../StoryPage.js';

export default class Page01Opening extends StoryPage {
  render() {
    const el = super.render();
    el.classList.add('page-opening');
    el.innerHTML = `
      <div class="opening-content">
        <div class="avatar-wrapper">
          <div class="avatar-ring"></div>
          <div class="avatar-placeholder">
            <svg class="threads-icon" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg">
  ...
  async animateIn(el) {
    ...
    ring.classList.add('spin-in');

    await this.delay(300);

    // 頭像縮放彈入
    const avatar = el.querySelector('.avatar-placeholder');
    avatar.classList.add('scale-in');

    await this.delay(400);

    // 文字依序淡入
    const texts = el.querySelectorAll('.opening-text > *');
    ...
    await this.delay(300);
    el.querySelector('.tap-hint').classList.add('visible');
  }
}
